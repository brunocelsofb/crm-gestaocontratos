...
export const FIXED_FIELDS: Omit<PipelineFieldConfig, 'visibility'>[] = [
  ...
  { field_key: 'classification',      field_label: 'Classificação',                display_order: 6 },
  { field_key: 'segment',             field_label: 'Segmento',                     display_order: 7 },
  { field_key: 'contact_name',        field_label: 'Nome do contato',               display_order: 8 },
  { field_key: 'contact_email',       field_label: 'E-mail do contato',             display_order: 9 },
  { field_key: 'contact_phone',       field_label: 'Telefone do contato',           display_order: 10 },
  { field_key: 'contact_cargo',       field_label: 'Cargo do contato',              display_order: 11 },
  { field_key: 'cnpj_client',         field_label: 'CNPJ do Cliente',               display_order: 12 },
  { field_key: 'cnpj_orbis',          field_label: 'CNPJ da ORBIS (contratada)',    display_order: 13 },
  { field_key: 'description',         field_label: 'Descrição / Observação',        display_order: 14 },
]
