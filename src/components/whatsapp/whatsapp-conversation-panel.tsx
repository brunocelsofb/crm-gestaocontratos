    ...
    <div className="flex flex-col h-full min-h-0">
      ...
      {isArchived ? (
        ...
        <div className="flex-shrink-0 space-y-2 rounded-lg border border-gray-200 bg-white p-3">
          ...
          {/* NOVA BARRA DE MENSAGEM (Com botão redondo, mas sem anexo para evitar erro) */}
          <div className="flex items-end gap-2 bg-white rounded-md border border-gray-300 p-1 focus-within:border-[#1B556B]">
            ...
            <div className="flex-1 min-w-0 flex flex-col">
              <textarea
                ...
                rows={1}
                className="w-full px-3 py-2 text-sm bg-transparent outline-none resize-none overflow-y-auto"
            ...
            <button 
              ...
              className="p-2 mb-[2px] mr-[2px] rounded-full bg-[#1B556B] text-white hover:bg-[#164659] disabled:opacity-50 disabled:bg-gray-300 disabled:text-gray-500 transition-colors shrink-0"
