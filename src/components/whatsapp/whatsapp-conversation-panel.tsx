...
import { 
  ...
  sendUnlinkedWhatsAppMedia, // <-- Adicionado para suportar envio de arquivo aqui
...
export function WhatsAppConversationPanel({
  ...
  async function handleFileUpload() {
    ...
    // Forçando as any para evitar erro de TS caso sua função limite a 'image' | 'document'
  ...
  async function handleReply() {
    // Se tiver arquivo, prioriza o envio de mídia
    ...
    <div className="flex flex-col h-full min-h-0">
      ...
      {isArchived ? (
        ...
        <div className="flex-shrink-0 space-y-2 rounded-lg border border-gray-200 bg-white p-3">
          ...
          {/* Seletor de Instância Preservado */}
          ...
          {/* NOVA BARRA DE MENSAGEM (Com botão de Anexo) */}
